...
public class NotificationsServiceIMPL implements NotificationsService {
	...
	public PagedResult<NotificationsResponseDTO> getAll(Pageable pageable) {
		...
		return PagedResult.<NotificationsResponseDTO>builder().content(dtoList)
				.totalElements((int) notificationsPage.getTotalElements()).totalPages(notificationsPage.getTotalPages())
				.currentPage(notificationsPage.getNumber()).pageSize(notificationsPage.getSize()).build();
	}
