...
public class AuthController {
	...
	public SuccessReponse<Boolean> signUp(@RequestBody @Valid SignUpRequest request) {
...
//		log.info("{}", user.getUserName());
	...
	public SuccessReponse<SignInResponse> signIn(@RequestBody @Valid SignInRequest request) {
		...
		return SuccessReponse.of(SignInResponse.builder().token(accessToken).expiredDate(expriedDate).build());
	}
}